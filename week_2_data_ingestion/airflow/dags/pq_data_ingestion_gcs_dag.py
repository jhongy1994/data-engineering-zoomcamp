...
dataset_url = f"https://s3.amazonaws.com/nyc-tlc/trip+data/{parquet_file}"
...
default_args = {
    ...
    "depends_on_past": False, #이전 주기의 run에 따라 현재 task 실행여부 결정
    "retries": 1,
}

with DAG(
    dag_id="pq_data_ingestion_gcs_dag",
